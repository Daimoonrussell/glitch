          ...
          <nav className="sticky top-0 left-0 w-screen z-50 bg-white/10 backdrop-blur-lg shadow-lg border-b border-white/10 transition-all duration-300">
            <div className="w-full max-w-screen-lg mx-auto flex items-center justify-between px-2 py-4">
              <div className="flex-shrink-0">
                <Link href="/">
                  <img src="/assets/images/logo.png" alt="GLITCHSTUDIO logo" className="h-10 w-auto animate-logo-glitch" />
                </Link>
              </div>
              ...
              <ul className="navbar hidden sm:flex flex-row items-center gap-x-8 text-base font-semibold text-gray-100 ml-auto tracking-wider">
                <li><Link href="#kim-jestesmy">O nas</Link></li>
                <li><Link href="#oferta">Oferta</Link></li>
                <li><Link href="#proces">Proces</Link></li>
          ...
          {open && (
            <div className="fixed inset-0 z-40 bg-black/80 backdrop-blur-md flex flex-col items-center justify-start pt-24 transition-all duration-300 animate-mobile-menu">
              <ul className="flex flex-col items-center gap-y-8 text-lg font-semibold text-white">
                <li><Link href="#kim-jestesmy" onClick={() => setOpen(false)}>O nas</Link></li>
                <li><Link href="#oferta" onClick={() => setOpen(false)}>Oferta</Link></li>
                <li><Link href="#proces" onClick={() => setOpen(false)}>Proces</Link></li>
            ...
            <Section yPadding="pt-16 pb-32">
              <header className="text-center max-w-3xl mx-auto flex flex-col items-center justify-center">
                <div className="flex flex-col items-center justify-center mb-4">
                  <img src="/assets/images/logo.png" alt="GLITCHSTUDIO logo" className="block sm:hidden mb-2 h-12 w-auto animate-logo-glitch" />
                  <span className="hero-brutal text-5xl md:text-6xl font-extrabold tracking-tight mt-2 drop-shadow-lg uppercase block leading-tight md:leading-[1.05] animate-hero-glitch-gradient" style={{letterSpacing: '0.04em', color: '#fff'}}>
                    Nowoczesne,<br />digital-native
                  </span>
                </div>
                <div className="text-xl mb-4 text-primary-300 font-semibold tracking-widest" style={{ fontFamily: 'Syne, Arial, Helvetica, sans-serif' }}>
                  Design, który glitchuje algorytmy i zostaje w głowie.<br />
                  Branding, web i narracja wizualna dla tych, którzy nie chcą być kolejni.
                </div>
                  ...
                  <Link href="#kontakt">
                    <div className="relative group">
                      <div className="btn btn-glitch font-bold px-6 py-3 rounded-xl bg-gradient-to-r from-gray-800 via-gray-900 to-gray-700 text-white shadow-xl border-2 border-primary-400/60 backdrop-blur-md transition-all duration-300 group-hover:scale-105 group-hover:shadow-neon group-hover:border-primary-300 focus:outline-none focus:ring-4 focus:ring-primary-400/40 relative overflow-hidden">
                        ...
                        <span className="absolute left-0 top-0 w-full h-full pointer-events-none opacity-0 group-hover:opacity-100 animate-glitch mix-blend-screen z-20" aria-hidden="true"></span>
                      </div>
                    </div>
                  </Link>
                  <Link href="#oferta">
